...
(function () {
  ...
  require.config({
    ...
    paths: {
      ...
      nmodule: '/module',
      'nmodule/uitest': 'build/karma/src',
      'nmodule/uitestTest': 'build/karma/srcTest',
  ...
  define('nmodule/uitest/rc/uitest.built.min');
  ...
  require([ 'niagara-test-server/karmaUtils',
    ...
    karmaUtils.setupAndRunSpecs({
      user: 'admin',
      pass: 'asdf1234',
      specs: [ 'nmodule/uitestTest/rc/spec/allSpecs' ]
    }, function (err) {
